            ...
            >
                ...
                >
                    <button id="toggle-navbar" onclick="toggleNavbar()">
                        <img
                            src="{{ asset('template/assets/img/global/burger.svg') }}"
                            class="mb-2"
                            alt=""
                        />
                    </button>
            ...
            >
                <div class="nav-input-group">
                    ...
                    <button class="btn-nav-input">
                        <img
                            src="{{ asset('template/assets/img/global/search.svg') }}"
                            alt=""
                        />
                    </button>
                </div>
        ...
        <div class="content">
            ...
            <div class="row mt-5 pb-5">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div
                        class="d-flex flex-column justify-content-between align-items-center employee-card w-100"
                    >
                        <img
                            src="{{ asset('template/assets/img/employees/photo-6.png') }}"
                            alt=""
                            class="employee-img"
                        />
                        ...
                        <div
                            class="d-flex justify-content-center align-items-center employee-status verified"
                        >
                            <div class="employee-status-image">
                                <img
                                    src="{{ asset('template/assets/img/employees/check.svg') }}"
                                    alt=""
                                />
                            </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    >
                        <img
                            src="{{ asset('template/assets/img/employees/photo-4.png') }}"
                            alt=""
                            class="employee-img"
                        />
                        ...
                        <div
                            class="d-flex justify-content-center align-items-center employee-status unverified"
                        >
                            <a href="#">Verify Now</a>
                        </div>
                    </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    >
                        <img
                            src="{{ asset('template/assets/img/employees/photo.png') }}"
                            alt=""
                            class="employee-img"
                        />
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    >
                        <img
                            src="{{ asset('template/assets/img/employees/photo-7.png') }}"
                            alt=""
                            class="employee-img"
                        />
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    >
                        <img
                            src="{{ asset('template/assets/img/employees/photo-5.png') }}"
                            alt=""
                            class="employee-img"
                        />
